...
from .views import ReservarCita, finalizar_cita, HistorialCitasView, cancelar_cita, citas_pendientes_cliente, citas_terminadas_cliente
...
urlpatterns = [
    ...
    path('terminadas/cliente/', citas_terminadas_cliente),
]